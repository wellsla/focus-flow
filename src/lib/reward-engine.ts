...
export const BADGES: Record<BadgeId, Badge> = {
  "first-step": {
    id: "first-step",
    name: "Primeiro Passo",
    description: "Completou a primeira rotina do dia",
    emoji: "👣",
  },
  "deep-focus": {
    id: "deep-focus",
    name: "Foco Profundo",
    description: "3 pomodoros completos seguidos",
    emoji: "🎯",
  },
  writer: {
    id: "writer",
    name: "Escritor",
    description: "7 dias seguidos de diário",
    emoji: "✍️",
  },
  resilient: {
    id: "resilient",
  ...
  "week-warrior": {
    ...
    description: "Completou rotinas por 7 dias seguidos",
    emoji: "⚔️",
  },
  "focus-master": {
    id: "focus-master",
    name: "Mestre do Foco",
    description: "25 sessões de pomodoro completas",
    emoji: "🧘",
  },
};
