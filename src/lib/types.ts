...
export type RoadmapNodeStatus = 'done' | 'in_progress' | 'todo' | 'skipped' | 'parallel';
...
export type DashboardCardFeature = 'applications' | 'routine' | 'finances' | 'time' | 'goals';
...
export type DashboardCard = {
    ...
    details?: { title: string; label: string; rawValue?: any }[];
}
